    ...
    <div class="row">
    	...
    	<div class="col-md-12" style="margin-top:50px;">
    	    <div class="x_panel">
    	        ...
    	        <div class="x_title">
    	            <h2>Enter Refund Information Of Order Cancelletion Order Item Id = {{$order_item->id}}</h2>
    	        ...
    	        <div>
    	            <div class="x_content">
    	            	...
    	            	{{ Form::open(['method' => 'put','route'=>['admin.order_refund_info_insert','order_item_id'=>$order_item->id] ]) }}

                        <div class="well" style="overflow: auto">
                            <div class="form-row mb-10">
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                  <label for="name">Name As Per Bank Account</label>
                                  <input type="text" class="form-control" name="name"  placeholder="Enter Name As Per Bank Account"  required>
                                    @if($errors->has('name'))
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="branch_name"  placeholder="Enter Bank Name"  required>
                                </div>

                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    <label for="ac_no">Account Number</label>
                                    <input type="number" class="form-control" name="ac_no"  placeholder="Enter Account Number" required>
                                </div>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12 mb-3">
                                    <label for="amt">Refund Amount</label>
                                    <input type="text" class="form-control" name="amt"  placeholder="Enter IFSC Code" disabled value="{{$refund_amount}}">
                                </div>
