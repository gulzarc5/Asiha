            ...
            <div class="row ashia-mb-n40">
                    ...
                    <div class="product-images vertical">
                        <div>
                            <button class="product-gallery-popup hintT-left" data-hint="Click to enlarge"
                                data-images='[
                                    {"src": "{{asset('web/images/product/s328/product-9.jpg')}}", "w": 810, "h": 1080},
                        ...
                        <div class="product-gallery-slider">
                            <div class="product-zoom" data-image="{{asset('web/images/product/s328/product-9.jpg')}}">
                                <img src="{{asset('web/images/product/s328/product-9.jpg')}}" alt="">
                            </div>
                ...
                <div class="col-lg-6 col-12 ashia-mb-40">
                    <div class="product-summery">
                        ...
                        <div class="product-price"><span class="old">₹60.00</span>₹55.00 </div>
