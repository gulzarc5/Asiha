            ...
            <div class="row ashia-mb-n30">
                ...
                <div class="col-lg-10 col-12 ashia-mb-30 mx-auto">
                    <div class="dashboard row">
                        ...
                        <div class="col-lg-4 col-xs-6"><a href="{{route('web.wishlist.wishlist')}}"> <i class="far fa-heart"></i> Wishlist</a></div>
                        <div class="col-lg-4 col-xs-6"><a href="{{route('web.address.address')}}"> <i class="far fa-map-marker-alt"></i> Address</a></div>
                        <div class="col-lg-4 col-xs-6"><a href="{{route('web.profile.profile')}}"> <i class="far fa-user"></i> Profile</a></div>
